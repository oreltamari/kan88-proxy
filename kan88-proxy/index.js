...
res.redirect(`https://kan88proxy.vercel.app/?spotify_token=${encodeURIComponent(access_token)}`);    res.redirect(`https://kan88proxy.vercel.app/?spotify_token=${access_token}`);
  } catch (e) {
